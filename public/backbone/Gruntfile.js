...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            karma: {
                files: ['<%= yeoman.app %>/.tmp/scripts/**/*.js', '<%= yeoman.app %>/../test/dist/spec/**/*.coffee'],
                tasks: ['coffee:test'] //NOTE the :run flag
            }
        },
        connect: {
            options: {
        ...
        handlebars: {
            compile: {
                ...
                files: {
                    '<%= yeoman.app %>/scripts/templates/templates.js': '<%= yeoman.app %>/scripts/templates/*.hbs'
                }
            }
        },
        jst: {
            ...
            compile: {
                files: {
                    '.tmp/scripts/templates.js': ['<%= yeoman.app %>/scripts/templates/*.js']
                }
            }
        },
        rev: {
